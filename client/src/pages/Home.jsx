      ...
      <div className="flex-grow flex flex-col items-center justify-center p-6 w-full">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mt-12  max-w-7xl w-full">
          ...
          >
            ...
            >
              Connect with{" "}
              <span className="text-primary hover:text-secondary transition-colors duration-300">
                Anyone
              </span>{" "}
              <br />
              Anywhere.
            ...
            >
              Experience seamless, real-time messaging with top-tier security
              and a beautiful, intuitive design. Stay close to the people who
              matter most.
            </motion.p>
            ...
            >
              <div className="card-body items-center text-center">
                <motion.div
                  ...
                  animate="animate"
                  className={`text-6xl mb-4 ${feature.iconBg} ${feature.iconColor} p-4 rounded-2xl`}
                >
                  {feature.icon}
                </motion.div>
      ...
      <footer className="footer p-10 bg-base-300 text-base-content mt-auto w-full border-t border-base-200">
        <aside>
          <motion.div
            ...
            className="text-4xl mb-2 cursor-pointer text-primary"
          >
            <BsChatDotsFill />
          </motion.div>
          <p className="font-bold text-lg">
            ChatApp Industries Ltd.
            <br />
        ...
        <nav>
          ...
          <a className="link link-hover hover:text-secondary transition-colors">
            About us
          </a>
          <a className="link link-hover hover:text-secondary transition-colors">
            Contact
        ...
        <nav>
          ...
          <a className="link link-hover hover:text-accent transition-colors">
            Terms of use
          </a>
          <a className="link link-hover hover:text-accent transition-colors">
            Privacy policy

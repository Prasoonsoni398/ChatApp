...
const Chat = () => {
  ...
  return (
    <div className="flex h-screen bg-base-200 overflow-hidden text-base-content">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-baseline mb-0.5">
                  ...
                  <span className={`text-xs ${chat.unread ? 'text-primary font-medium' : 'text-base-content/50'}`}>
                    {chat.time}
                  </span>
                </div>
      ...
      {/* Main Chat Area */}
      <div className={`flex-1 flex flex-col bg-[url('https://static.whatsapp.net/rsrc.php/v3/yl/r/r_QxI4xW8H8.png')] bg-repeat bg-center ${!selectedChat ? 'hidden md:flex' : 'flex'}`} style={{ backgroundColor: '#efeae2', backgroundBlendMode: 'overlay' }}>
        {selectedChat ? (
          <>
            {/* Chat Header */}
            <div className="h-16 px-4 flex items-center gap-3 bg-base-100 border-b border-base-300 shadow-sm z-10">
              ...
              <div className="flex gap-4 text-base-content/60">
                ...
                <button className="hover:text-primary"><BsThreeDotsVertical size={20} /></button>
              </div>
            </div>
                    ...
                    >
                      <div className="chat-avatar avatar">
                        <div className="size-10 rounded-full">
                          <img src={isMe ? (loggedInUser?.avatar || "https://api.dicebear.com/7.x/avataaars/svg?seed=Me") : selectedChat.avatar} alt="avatar" />
                        </div>
                      </div>
            ...
            {/* Input Area */}
            <div className="relative min-h-[64px] bg-base-100 px-4 py-3 flex flex-col justify-end border-t border-base-300">
              {imagePreview && (

...
const useChatState = () => {
  ...
  const [selectedChat, setSelectedChat] = useState(() => {
    try { return JSON.parse(sessionStorage.getItem("selectedChat")) || null; }
    catch { return null; }
  });
  ...
  const [contextMenu, setContextMenu] = useState({
    visible: false, x: 0, y: 0, messageId: null, isMe: false, text: "", msg: null,
  });
  ...
  return {
    ...
    clearedMessagesBackup, setClearedMessagesBackup,
    showClearUndoBanner, setShowClearUndoBanner,
    clearUndoTimeoutRef, messagesEndRef, fileInputRef,
    profileMenuRef, headerMenuRef, emojiPickerRef,
    emojiToggleBtnRef, reactionTimeoutRef,
    message, setMessage,

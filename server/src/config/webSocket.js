      ...
      if (payload.groupId) {
        ...
        if (group) {
          group.members.forEach((memberId) => {
            ...
            if (
              memberId.toString() !== payload.senderId?.toString() &&
              memberId.toString() !== payload.senderId?._id?.toString()
            ) {
        ...
        if (receiverSocketId) {
          ...
          try {
            await Message.findByIdAndUpdate(payload._id, {
              status: "delivered",
            });
